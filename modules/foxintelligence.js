...
var _cleanHtml = function (string) {
...
//            var str = evt.target.result;
        let str = _cleanHtml(html);
        let json = parseHtml(str);
        
        console.log('json = ',json);

//        let toDownload = new Blob([json], {type: 'application/json'});
//        let link = window.URL.createObjectURL(toDownload);
